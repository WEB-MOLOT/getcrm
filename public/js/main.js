...
$(document).ready(function () {
  ...
  //   contactManagerModalWindowClose = contactManagerModalWindow.querySelector(
  //     ".modal_connection__close"
  //   ),
  //   personalAccountBtn = document.querySelector(".hr_lk--link"),
  //   loginModalWindow = document.querySelector(".modal_personal_account"),
  //   loginModalWindowClose = loginModalWindow.querySelector(
  //     ".modal_personal_account__close"
  //   ),
  //   registrationLink = loginModalWindow.querySelector(".login__link"),
  //   forgotPassword = loginModalWindow.querySelector(".forgot_pass"),
  //   modalRestoringAccess = document.querySelector(".modal_restoring_access"),
  //   modalRestoringAccessClose = modalRestoringAccess.querySelector(
  //     ".modal_restoring_access__close"
  //   ),
  //   modalRegistrationForm = document.querySelector(".modal_registration"),
  //   modalRegistrationClose = modalRegistrationForm.querySelector(
  //     ".modal_registration__close"
  //   ),
  //   registrationLiginBtn = modalRegistrationForm.querySelector(
  //     ".modal_registration__link"
  //   ),
  //   subscriptionModal = document.querySelector(".subscription_modal"),
  //   subscriptionModalOkBtn = subscriptionModal.querySelector(
  //     ".subscription_modal__btn"
  //   ),
  //   footerSubscription = document.querySelector(".footer_subscribe_inside"),
  //   subscriptionModalCloseBtn = subscriptionModal.querySelector(
